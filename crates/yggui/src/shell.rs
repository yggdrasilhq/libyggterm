...
mod tests {
    ...
    fn merged_sidebar_rows_compress_single_child_remote_folder_chains() {
        ...
        assert!(rows.iter().any(|row| {
            row.kind == BrowserRowKind::Group
                && row.full_path == "__remote_folder__/jojo/mnt/net/data/netshare/dada/obsidian/codex"
    ...
    fn merged_sidebar_rows_include_live_remote_session_when_scan_snapshot_is_missing_it() {
        let rows = merged_sidebar_rows(
            ...
            &[ManagedSessionView {
                ...
                metadata: vec![
                    SessionMetadataEntry { label: "Cwd", value: "/home/user".to_string() },
                    SessionMetadataEntry { label: "Storage", value: "/home/user/.codex/sessions/foo.jsonl".to_string() },
    ...
    fn search_sidebar_matches_include_group_rows() {
        ...
        assert!(matches.iter().any(|row| row.full_path == "__remote_folder__/oc/home/user/gh"));
    }
    ...
    fn search_expanded_paths_include_collapsed_remote_sessions() {
        ...
        assert!(rows.iter().any(|row| row.full_path == "__remote_folder__/oc/home/user/gh/excel-inspired"));
