...
static TERMINAL_THEME_CATALOG: Lazy<Vec<NamedTerminalTheme>> = Lazy::new(|| {
    let mut themes = vec![NamedTerminalTheme {
        ...
        palette: TerminalPaletteSpec {
            background: "#f3f3f3".to_string(),
            foreground: "#1f1f1f".to_string(),
            cursor: "#005fb8".to_string(),
            selection: "rgba(0, 95, 184, 0.18)".to_string(),
            black: "#1f1f1f".to_string(),
            ...
            white: "#5f6b76".to_string(),
            bright_black: "#7f8c98".to_string(),
